...
<main>
	<div class="flex max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
		<div class="hidden bg-cover lg:block lg:w-1/2" style="background-image:url('img/oj2.jpg')">
		</div>

		<div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
			<img src="/img/logo.svg" alt="logo" class="h-8 mx-auto">

			<p class="text-xl text-center text-gray-600 dark:text-gray-200 font-medium">We're eager to have you!</p>
