  ...
  -->
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <a href="/" class="flex-shrink-0 flex items-center gap-2">
                    ...
                    <p class="hidden md:inline-block text-2xl text-w font-logo font-semibold text-gray-700">
                        honeyside</p>
                </a>
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              ...
              To: "transform opacity-0 scale-95"
                        ...
                        <div
                            ...
                            <a href="/profile" class="hover:bg-gray-200 block px-4 py-2 text-sm text-gray-700"
                               role="menuitem"
                            ...
                            ?>
                            <a href="/logout" class="hover:bg-gray-200 block px-4 py-2 text-sm text-gray-700"
                               role="menuitem"
