            ...
            <div class="res__form">
                ...
                <div id="gst_ctrl" class="my-4 hidden">
                    <div class="flex justify-between w-full my-8 items-center">
                        ...
                        <div id="add_gst"
                             class="flex items-center hover:bg-gray-300 py-2 px-3 rounded-lg cursor-pointer">
                ...
                <div>
                    ...
                    <div id="slc_res_type" class="flex flex-col md:flex-row md:items-center md:justify-between">
                        <div id="pension_container"
                             class="flex flex-row gap-5 justify-center md:justify-end mt-4 w-full">
                        </div>
                    </div>
                </div>
            </div>
